package com.denzo.daschess.model;
...
public class ActivityRedirectionModel {
    ...
    public static ActivityRedirectionModel generateForUser(@NonNull UsageEvents.Event event) {
    ...
    public static ActivityRedirectionModel generateForCommitCompare(@NonNull UsageEvents.Event event) {
    ...
    public static ActivityRedirectionModel generateForCommit(@NonNull UsageEvents.Event event, int index) {
        return generateRepoInfo(event, Type.Commit)
                .setCommitSha(event.getPayload().getCommits().get(index).getSha());
    }

    public static ActivityRedirectionModel generateForRelease(@NonNull UsageEvents.Event event) {
